...
Noto font provides different font files for each character set of various languages. The theme itself only loads Noto Sans with the basic latin character set, so it's recommended to use [Noto Font Loader](https://github.com/htmsk138/noto-font-loader) that automatically loads the correct font file for your site's language. The plugin also lets you use Noto Serif besides Noto Sans.
